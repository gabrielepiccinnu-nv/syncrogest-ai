  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        intervento_ticket_id: { type: 'number', description: 'ID ticket da collegare a questo intervento (opzionale — usare quando l\'utente chiede di creare un intervento "dal ticket" o "collegato al ticket")' },
        intervento_matt_da: { type: 'string', description: 'Ora inizio prima fascia HH:MM (es. "09:00") — usare per il primo blocco orario indipendentemente che sia mattina o pomeriggio' },
        intervento_matt_a: { type: 'string', description: 'Ora fine prima fascia HH:MM (es. "12:30")' },
        intervento_pome_da: { type: 'string', description: 'Ora inizio seconda fascia HH:MM (es. "14:00") — usare per il secondo blocco orario se ce ne sono due' },
        intervento_pome_a: { type: 'string', description: 'Ora fine seconda fascia HH:MM (es. "18:00")' },
